package com.barclaycardus.data.configuration;

import com.barclaycardus.data.util.SecurityUtil;
...
public class DataSourceConfig {
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactory()
    {
        ...
        localContainerEntityManagerFactoryBean.setPackagesToScan(new String[]{"com.barclaycardus.data.entities"});
    ...
    DataSource dataSource() throws SQLException
    {
        ...
        try
        {
            dataSource= DataSourceBuilder.create()
                    ...
                    .password(securityUtil.decryptPassword(passwordKey))
                    .url(url)
